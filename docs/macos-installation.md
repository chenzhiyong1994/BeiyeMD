...
| 你的 Mac | 文件 |
| --- | --- |
| M1、M2、M3、M4 等 Apple 芯片 | `BeiyeMD-1.1.3-mac-arm64.dmg` |
| Intel 芯片 | `BeiyeMD-1.1.3-mac-x64.dmg` |
...
```bash
shasum -a 256 BeiyeMD-1.1.3-mac-arm64.dmg
# Intel 版本则将文件名改为 BeiyeMD-1.1.3-mac-x64.dmg
```
