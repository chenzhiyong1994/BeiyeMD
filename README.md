<div align="center">
  ...
  <p>
    ...
    <img src="https://img.shields.io/badge/version-1.1.2-111111" alt="BeiyeMD 1.1.2">
...
<p align="center">
  <a href="https://github.com/chenzhiyong1994/BeiyeMD/releases/latest"><strong>Download BeiyeMD 1.1.2 for Windows or macOS</strong></a>
  ·
...
## Version 1.1.2 · Source fidelity and denser reading

This patch preserves the original Markdown when switching between Preview and Source, so editor normalization no longer restores deleted blank lines between list items. It also tightens Source line spacing and the vertical rhythm of Preview text, lists, headings, and blocks so more content fits on a laptop screen. Installers and one SHA-256 checksum file are published on [GitHub Releases](https://github.com/chenzhiyong1994/BeiyeMD/releases/tag/v1.1.2).
...
| --- | --- | --- |
| Windows x64 | Most 64-bit Windows PCs | `BeiyeMD-Setup-1.1.2-Windows-x64.exe` |
| macOS arm64 | Macs with Apple silicon (M1, M2, M3, M4, and later) | `BeiyeMD-1.1.2-mac-arm64.dmg` |
| macOS x64 | Intel-based Macs | `BeiyeMD-1.1.2-mac-x64.dmg` |
